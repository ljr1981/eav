...
feature -- Creation Tests
	...
	test_SELECT_operation
		...
		do
			...
			create l_mock.make_with_reasonable_defaults
			l_results := l_manager.database.fetch_Object_list_by_SELECT (l_mock, l_manager.SELECT_all_with_filters (l_mock, <<>>))
			...
			create l_mock.make_with_reasonable_defaults
			l_results := l_manager.database.fetch_Object_list_by_SELECT (l_mock, l_manager.SELECT_all_with_filters (l_mock, <<["first_name", "=", "'Fred'", ""]>>))
			...
			create l_mock.make_with_reasonable_defaults
			l_results := l_manager.database.fetch_Object_list_by_SELECT (l_mock, l_manager.SELECT_all_with_filters (l_mock, <<["age", "=", "30", ""]>>))
